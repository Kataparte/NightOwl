...
hyprctl dispatch exec [workspace 9] "kitty --class sys_fetch -o font_size=15 -o window_padding_width=60 -e bash -c 'fastfetch; read'"

# 4. Launch Filler Visualizer (Bottom Right)
...
hyprctl dispatch exec [workspace 9] "kitty --class sys_matrix -e /usr/bin/pipes.sh -c #f3b3e4"
